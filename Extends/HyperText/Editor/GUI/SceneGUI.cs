...
//					s_Skin.window = null;
		...
		public static bool DisplayCapButton(int id, Vector3 position, Quaternion orientation, float size, Handles.CapFunction cap)
		{
		...
		)
		{
			...
			case EventType.Repaint:
			{
				...
				cap(id, position, orientation, size,EventType.ContextClick);
				break;
			}
